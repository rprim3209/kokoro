...
const DB = {
  ...
  mixaCica: { id:"mixaCica", name:"Balm Cica+ Multi-Use Reparierender Balm, 50 ml", brand:"Mixa", kat:"creme", schiene:"support", klassen:["support"], shape:"tube", c:"#7da8cc", wirk:"Cica (Madecassoside) + 5% Panthenol", nc:true, ff:true, cf:false, ean:"3600551183398", dan:"3118643", price:"5,95 €", img:"https://products.dm-static.com/images/f_auto,q_auto,c_fit,h_320,w_320/v1765787581/assets/pas/images/da6fbf35-1c6d-441e-8535-02f4b58871dd/mixa-balm-cica-multi-use-reparierender-balm", countries:["DE","AT","EU"], store:"dm / BIPA / Müller (~5,95 €)", truth:"Hervorragender reizarmer Cica-Balsam mit 5% Panthenol zur intensiven Regeneration gestresster oder rissiger Hautbarriere." },
  ...
  ordinaryNmfBetaGlucan: { id:"ordinaryNmfBetaGlucan", name:"Natural Moisturizing Factors + Beta Glucan, 100 ml", brand:"The Ordinary", kat:"creme", schiene:"support", klassen:["support", "humectant"], shape:"tube", c:"#ffffff", wirk:"Beta-Glucan + NMF + Ceramide", nc:true, ff:true, cf:true, cf_basis:"Leaping Bunny", ean:"769915232400", price:"14,40 €", img:"https://static.prod.ecom.mueller.de/products/769915232400/769915232400_1_02042026.jpg", countries:["AT","DE","EU"], store:"Müller (~14,40 €)", truth:"Ultraleichte Gel-Creme mit Beta-Glucan, hauteigenen Feuchthaltefaktoren (NMF) und Ceramiden zur optimalen Feuchtigkeitsversorgung ohne zu beschweren." },

  // Müller & BIPA Eigenmarken (DACH-Staples & Naturkosmetik)
  m_cv_hydro: { id:"m_cv_hydro", name:"CV Hydro Feuchtigkeitsgel 24h", brand:"CV CadeaVera", kat:"creme", schiene:"support", klassen:["support","humectant"], shape:"tube", c:"#6bb5a3", wirk:"Hyaluron + Kaktusfeige (Ölfrei)", nc:true, ff:true, cf:false, ean:"4068400012111", countries:["AT","DE"], store:"Müller (~3,95 €)", truth:"Leichtes ölfreies Feuchtigkeitsgel, verstopft keine Poren und spendet intensive Feuchte." },
  m_cv_med_wash: { id:"m_cv_med_wash", name:"CV Med Ultra Sensitiv Reinigungsschaum", brand:"CV CadeaVera", kat:"reiniger", schiene:"support", klassen:[], shape:"pump", c:"#7ebbc4", wirk:"Panthenol & Tensid-mild (pH 5.5)", nc:true, ff:true, cf:false, ean:"4068400012227", countries:["AT","DE"], store:"Müller (~3,45 €)", truth:"Milder Schaum ohne Duftstoffe und ohne austrocknende Sulfate für sensible Haut." },
  m_cv_sun: { id:"m_cv_sun", name:"CV Sun Mattierendes Sonnenfluid LSF 50+", brand:"CV CadeaVera", kat:"spf", schiene:"support", klassen:["uv"], shape:"tube", c:"#ecd37b", wirk:"UVA/UVB Breitbandfilter (Matt)", nc:true, ff:true, cf:false, ean:"4068400012449", countries:["AT","DE"], store:"Müller (~5,95 €)", truth:"Zuverlässiger UV-Schutz mit Matt-Finish für den Alltag ohne Weißeln." },
  m_terra_mizell: { id:"m_terra_mizell", name:"Terra Naturi Sanftes Mizellenwasser Bio-Mandel", brand:"Terra Naturi", kat:"reiniger", schiene:"support", klassen:[], shape:"glass", c:"#89bfe3", wirk:"Bio-Mandel & Aloe Vera", nc:true, ff:true, cf:true, cf_basis:"NATRUE & Vegan", ean:"4068400021113", countries:["AT","DE"], store:"Müller (~2,75 €)", truth:"Zertifizierte Naturkosmetik ohne Duftstoffe für reizarme Reinigung." },
  m_terra_creme: { id:"m_terra_creme", name:"Terra Naturi 24h Feuchtigkeitscreme Bio-Aloe", brand:"Terra Naturi", kat:"creme", schiene:"support", klassen:["support"], shape:"tube", c:"#bad19f", wirk:"Bio-Aloe Vera & Hyaluron", nc:true, ff:false, cf:true, cf_basis:"NATRUE & Vegan", ean:"4068400021229", countries:["AT","DE"], store:"Müller (~3,95 €)", truth:"Reichhaltige pflanzliche Feuchtigkeitspflege mit natürlichen ätherischen Essenzen." },
  m_aveo_wash: { id:"m_aveo_wash", name:"Aveo Med Waschlotion pH 5,5", brand:"Aveo", kat:"reiniger", schiene:"support", klassen:[], shape:"pump", c:"#76a9c7", wirk:"Seifenfreies Syndet pH 5.5", nc:true, ff:true, cf:false, ean:"4068400031112", countries:["AT","DE"], store:"Müller (~1,95 €)", truth:"Günstige und reizarme Waschemulsion zur Stabilisierung des Säureschutzmantels." },
  m_aveo_urea: { id:"m_aveo_urea", name:"Aveo Med 5% Urea Feuchtigkeitscreme", brand:"Aveo", kat:"creme", schiene:"support", klassen:["support"], shape:"jar", c:"#99c2b4", wirk:"5% Urea + Panthenol", nc:true, ff:true, cf:false, ean:"4068400031228", countries:["AT","DE"], store:"Müller (~3,45 €)", truth:"Wirksame Barriere-Begleitpflege bei schuppiger, trockener Haut." },
  bipa_bg_milch: { id:"bipa_bg_milch", name:"bi good Natürliche Reinigungsmilch Weiße Seerose", brand:"bi good", kat:"reiniger", schiene:"support", klassen:[], shape:"pump", c:"#89bfe3", wirk:"Bio-Seerose & Glycerin", nc:true, ff:true, cf:true, cf_basis:"NATRUE & Vegan", ean:"9005800201116", countries:["AT"], store:"BIPA (~3,29 €)", truth:"In Österreich hergestellte milde Naturkosmetik-Reinigungsmilch, trocknet nicht aus." },
  bipa_bg_creme: { id:"bipa_bg_creme", name:"bi good Natürliche 24h Feuchtigkeitscreme Melisse", brand:"bi good", kat:"creme", schiene:"support", klassen:["support"], shape:"tube", c:"#a4c8a8", wirk:"Bio-Melisse & Traubenkernöl", nc:true, ff:true, cf:true, cf_basis:"NATRUE & Vegan", ean:"9005800201222", countries:["AT"], store:"BIPA (~3,99 €)", truth:"Zertifizierte Naturkosmetik aus Österreich, beruhigt gestresste Haut spürbar." },
  bipa_bc_foam: { id:"bipa_bc_foam", name:"bi care Milder Reinigungsschaum Sanft & Frisch", brand:"bi care", kat:"reiniger", schiene:"support", klassen:[], shape:"pump", c:"#7ebbc4", wirk:"Panthenol + Aloe Vera", nc:true, ff:true, cf:false, ean:"9005800311112", countries:["AT"], store:"BIPA (~2,49 €)", truth:"Sehr sanfte und ergiebige Gesichtsreinigung ohne Parfüm." },
  bipa_bc_gel: { id:"bipa_bc_gel", name:"bi care Hydro Hyaluron Feuchtigkeitsgel", brand:"bi care", kat:"creme", schiene:"support", klassen:["support","humectant"], shape:"tube", c:"#6bb5a3", wirk:"Duo-Hyaluron + Niacinamid", nc:true, ff:true, cf:false, ean:"9005800311228", countries:["AT"], store:"BIPA (~3,79 €)", truth:"100% ölfrei und nicht-komedogen: Perfekt bei unreiner Haut oder Sommerhitze." },
  bipa_bc_sun: { id:"bipa_bc_sun", name:"bi care Mattierendes Sonnenfluid LSF 50+", brand:"bi care", kat:"spf", schiene:"support", klassen:["uv"], shape:"tube", c:"#ecd37b", wirk:"Breitbandschutz LSF 50+ & Vitamin E", nc:true, ff:true, cf:false, ean:"9005800311440", countries:["AT"], store:"BIPA (~5,49 €)", truth:"Zieht schnell ein, hinterlässt keinen Fettglanz und schützt vor lichtbedingter Hautalterung." },
...
const BABY_DB = {
  // Baby Heroes
  "b_item_1": { id:"b_item_1", name:"Ultra Sensitive Waschlotion", brand:"Babylove", slot:"reiniger", age:"baby_0_36m", ean:"", ff:true, u3:true, cf:true, nc:null, store:"dm (~2,25 €)", notes:"Mildeste Tenside ohne Seife oder Parfüm" },
  "b_item_2": { id:"b_item_2", name:"Ultra Sensitive Pflegecreme", brand:"Babylove", slot:"creme", age:"baby_0_36m", ean:"", ff:true, u3:true, cf:true, nc:null, store:"dm (~2,45 €)", notes:"Sanfte Basispflege mit Panthenol" },
  "b_item_3": { id:"b_item_3", name:"Wundschutzcreme Zink", brand:"Babylove", slot:"windel", age:"baby_0_36m", ean:"", ff:true, u3:true, cf:true, nc:null, store:"dm (~1,95 €)", notes:"Zinkoxid schützt vor Feuchtigkeit im Windelbereich" },
  "b_item_4": { id:"b_item_4", name:"Baby Sonnencreme LSF 50+", brand:"Paediprotect", slot:"spf", age:"baby_0_36m", ean:"", ff:true, u3:true, cf:true, nc:null, store:"dm / Rossmann (~6,95 €)", notes:"Reizarm ohne Duftstoffe, mineralisch-sensitiv" },
  "b_item_5": { id:"b_item_5", name:"Baby Calendula Bad parfümfrei", brand:"Weleda", slot:"reiniger", age:"baby_0_36m", ean:"", ff:true, u3:true, cf:false, nc:null, store:"Apotheke / dm (~8,50 €)", notes:"Pflanzliche Milde ohne Schaumbildner" },
  "b_item_6": { id:"b_item_6", name:"Stelatopia Gel Lavant", brand:"Mustela", slot:"reiniger", age:"baby_0_36m", ean:"", ff:true, u3:true, cf:false, nc:null, store:"Apotheke (~14 €)", notes:"Dermatologisches Reinigungsöl für atopische Babyhaut" },
  "b_item_7": { id:"b_item_7", name:"Baby Wundcreme", brand:"Das Boep", slot:"windel", age:"baby_0_36m", ean:"", ff:true, u3:true, cf:true, nc:null, store:"Apotheke / dm (~8,95 €)", notes:"Naturkosmetischer Zink-Wundschutz" },
  "b_item_9": { id:"b_item_9", name:"Anthelios Dermo-Pediatrics LSF 50+", brand:"La Roche-Posay", slot:"spf", age:"baby_0_36m", ean:"", ff:true, u3:true, cf:false, nc:null, store:"Apotheke (~19,50 €)", notes:"Pädiatrisch getesteter Höchstschutz" },


  // Müller & BIPA Baby Heroes
  "b_bb_wasch": { id:"b_bb_wasch", name:"Beauty Baby Kopf-bis-Fuß Waschlotion", brand:"Beauty Baby", slot:"reiniger", age:"baby_0_36m", ean:"4068400041111", ff:true, u3:true, cf:false, nc:null, countries:["AT","DE"], store:"Müller (~1,95 €)", notes:"Milde Tenside ohne Seife oder Parfüm, brennt nicht in den Augen" },
  "b_bb_wund": { id:"b_bb_wund", name:"Beauty Baby Wundschutzcreme Zink", brand:"Beauty Baby", slot:"windel", age:"baby_0_36m", ean:"4068400041227", ff:true, u3:true, cf:false, nc:null, countries:["AT","DE"], store:"Müller (~1,85 €)", notes:"Zinkoxid & Bio-Calendula schützen zuverlässig vor Feuchtigkeit" },
  "b_bb_creme": { id:"b_bb_creme", name:"Beauty Baby Zarte Pflegecreme", brand:"Beauty Baby", slot:"creme", age:"baby_0_36m", ean:"4068400041333", ff:true, u3:true, cf:false, nc:null, countries:["AT","DE"], store:"Müller (~1,65 €)", notes:"Panthenol & Mandelöl für sanfte Babygesichts- & Körperpflege" },
  "b_bb_spf": { id:"b_bb_spf", name:"Beauty Baby Sonnenmilch Sensitiv LSF 50+", brand:"Beauty Baby", slot:"spf", age:"baby_0_36m", ean:"4068400041449", ff:true, u3:true, cf:false, nc:null, countries:["AT","DE"], store:"Müller (~4,95 €)", notes:"Reizarm ohne Duftstoffe, hoher UVA/UVB-Schutz für zarte Babyhaut", spfNote:"AAP/AAD: unter 6 Monaten Schatten/Kleidung priorisieren" },

  "b_bw_wasch": { id:"b_bw_wasch", name:"Babywell Pflegendes Waschbalsam & Shampoo", brand:"Babywell", slot:"reiniger", age:"baby_0_36m", ean:"9005800411119", ff:true, u3:true, cf:false, nc:null, countries:["AT"], store:"BIPA (~1,99 €)", notes:"Bio-Kamille & mildeste Tenside, brennt nicht und schützt die Hautbarriere" },
  "b_bw_wund": { id:"b_bw_wund", name:"Babywell Zink-Wundschutzsalbe Spezial", brand:"Babywell", slot:"windel", age:"baby_0_36m", ean:"9005800411225", ff:true, u3:true, cf:false, nc:null, countries:["AT"], store:"BIPA (~1,79 €)", notes:"20% Zinkoxid & Panthenol beugen Rötungen im Windelbereich vor" },
  "b_bw_creme": { id:"b_bw_creme", name:"Babywell Zarte Pflegecreme Gesicht & Körper", brand:"Babywell", slot:"creme", age:"baby_0_36m", ean:"9005800411331", ff:true, u3:true, cf:false, nc:null, countries:["AT"], store:"BIPA (~1,69 €)", notes:"Schutzcreme mit Mandelöl und Sheabutter für sensible Babyhaut" },
  "b_bw_spf": { id:"b_bw_spf", name:"Babywell Sonnencreme Sensitiv LSF 50+", brand:"Babywell", slot:"spf", age:"baby_0_36m", ean:"9005800411447", ff:true, u3:true, cf:false, nc:null, countries:["AT"], store:"BIPA (~4,99 €)", notes:"Wasserfester Sofortschutz ohne Duftstoffe für Babys und Kleinkinder", spfNote:"AAP/AAD: unter 6 Monaten primär Schatten/Kleidung" },

  // Child Heroes
  "c_item_1": { id:"c_item_1", name:"Ultra Sensitiv 2in1 Dusche", brand:"SauBär", slot:"reiniger", age:"kind_3_11", ean:"", ff:true, u3:false, cf:true, nc:null, store:"dm (~1,95 €)", notes:"Sanfte Reinigung für aktive Kinder" },
  "c_item_2": { id:"c_item_2", name:"Pflegelotion Sensitiv", brand:"Paediprotect", slot:"creme", age:"kind_3_11", ean:"", ff:true, u3:false, cf:true, nc:null, store:"dm / Drogerie (~3,45 €)", notes:"Leichte Feuchtigkeitslotion ohne Mikroplastik" },
  "c_item_3": { id:"c_item_3", name:"Leichtkamm-Kindershampoo", brand:"SauBär", slot:"haar", age:"kind_3_11", ean:"", ff:true, u3:false, cf:true, nc:null, store:"dm (~1,95 €)", notes:"Brennt nicht in den Augen, erleichtert das Kämmen" },
  "c_item_4": { id:"c_item_4", name:"Waschlotion für Kinder", brand:"Sebamed", slot:"reiniger", age:"kind_3_11", ean:"", ff:true, u3:false, cf:false, nc:null, store:"Apotheke / dm (~6,50 €)", notes:"pH-Wert 5,5 stabilisiert den Säureschutzmantel" },
  "c_item_5": { id:"c_item_5", name:"Feuchtigkeitscreme", brand:"Cetaphil", slot:"creme", age:"kind_3_11", ean:"", ff:true, u3:false, cf:false, nc:null, store:"Apotheke (~12 €)", notes:"Intensive Barriere-Pflege bei trockener Kinderhaut" },
  "c_item_6": { id:"c_item_6", name:"Gebirgs- & Kindersonnencreme LSF 50+", brand:"Paediprotect", slot:"spf", age:"kind_3_11", ean:"", ff:true, u3:false, cf:true, nc:null, store:"Apotheke / dm (~9,95 €)", notes:"Wasserfester Breitbandschutz für Spiel & Sport" },
  "c_item_7": { id:"c_item_7", name:"Kids Shampoo Bio", brand:"Urtekram", slot:"haar", age:"kind_3_11", ean:"", ff:true, u3:false, cf:true, nc:null, store:"Bio-Markt / Online (~6,50 €)", notes:"Bio-Ringelblumen-Extrakt für geschmeidiges Kinderhaar" },
  "c_item_8": { id:"c_item_8", name:"ABCDerm Gel moussant", brand:"Bioderma", slot:"reiniger", age:"kind_3_11", ean:"", ff:true, u3:false, cf:false, nc:null, store:"Apotheke (~13,50 €)", notes:"Milde dermatologische Reinigungssyndet-Formel" },
  "c_item_9": { id:"c_item_9", name:"Lipikar Baume AP+M", brand:"La Roche-Posay", slot:"creme", age:"kind_3_11", ean:"", ff:true, u3:false, cf:false, nc:null, store:"Apotheke (~18,50 €)", notes:"Medizinischer Juckreiz-Stopp und Barriere-Aufbau" },
  "c_item_10": { id:"c_item_10", name:"Anthelios Dermo-Pediatrics Wet Skin LSF 50+", brand:"La Roche-Posay", slot:"spf", age:"kind_3_11", ean:"", ff:true, u3:false, cf:false, nc:null, store:"Apotheke (~19,50 €)", notes:"Lässt sich auch auf nasser Haut beim Baden auftragen" },
  "c_item_11": { id:"c_item_11", name:"Kindershampoo & Duschgel", brand:"Das Boep", slot:"haar", age:"kind_3_11", ean:"", ff:true, u3:false, cf:true, nc:null, store:"Apotheke / dm (~8,95 €)", notes:"Naturkosmetik-Formel für sensible Kopfhaut" },
...
// ==========================================
const TEEN_DB = {
  "t_item_1": { id:"t_item_1", name:"Ultra Sensitive Waschgel", brand:"Balea Med", slot:"reiniger", rawSlot:"basis_reiniger", age:"tween_teen", ean:"", ff:true, nc:true, cf:false, countries:"DE;AT;EU", store:"dm (~2,45 €)", notes:"Milde reizarme Drogerie-Reinigung für junge Haut" },
  "t_item_2": { id:"t_item_2", name:"Hautrein Klärendes Tonic BHA", brand:"Balea", slot:"active", rawSlot:"akne_active", age:"tween_teen", ean:"", ff:true, nc:true, cf:false, countries:"DE;AT;EU", store:"dm (~2,45 €)", notes:"Sanfte Salicylsäure gegen jugendliche Unreinheiten" },
  "t_item_3": { id:"t_item_3", name:"Ultra Sensitive Intensivcreme", brand:"Balea Med", slot:"creme", rawSlot:"basis_creme", age:"tween_teen", ean:"", ff:true, nc:true, cf:false, countries:"DE;AT;EU", store:"dm (~3,95 €)", notes:"Leichte Feuchtigkeitscreme mit Cica & Panthenol" },
  "t_item_4": { id:"t_item_4", name:"Ultra Sensitive Sonnenfluid LSF 50+", brand:"Balea Med", slot:"spf", rawSlot:"basis_spf", age:"tween_teen", ean:"", ff:true, nc:true, cf:false, countries:"DE;AT;EU", store:"dm (~5,95 €)", notes:"Leichter Breitband-UV-Schutz ohne Fettfilm" },

  // Müller & BIPA Teenie Heroes
  "t_cv_clear": { id:"t_cv_clear", name:"CV Clear Anti-Pickel Waschgel", brand:"CV CadeaVera", slot:"reiniger", rawSlot:"akne_reiniger", age:"tween_teen", ean:"4068400012333", ff:true, nc:true, cf:false, countries:"AT;DE", store:"Müller (~2,95 €)", notes:"Milde Salicylsäure (BHA) und Zink gegen jugendliche Hautunreinheiten" },
  "t_bg_serum": { id:"t_bg_serum", name:"bi good Natürliches Anti-Pickel Serum Johannisbeere", brand:"bi good", slot:"active", rawSlot:"akne_active", age:"tween_teen", ean:"9005800201338", ff:true, nc:true, cf:true, countries:"AT", store:"BIPA (~4,49 €)", notes:"Pflanzliches BHA (Weidenrinde) & Zink, NATRUE-zertifiziert & vegan" },
  "t_bc_sos": { id:"t_bc_sos", name:"bi care Anti-Pickel SOS Gel", brand:"bi care", slot:"active", rawSlot:"akne_active", age:"tween_teen", ean:"9005800311334", ff:true, nc:true, cf:false, countries:"AT", store:"BIPA (~2,29 €)", notes:"Punktuelles Notfallgel mit Zink PCA zur Beruhigung entzündeter Poren" },
